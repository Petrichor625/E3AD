...
<div align="center">
  <img src="static/images/visualization_5.png" width="80%" alt="Visual Image" />
</div>

*Comparative visualization of attention maps and our model performance on the DrivePilot dataset.(a)*



<div align="center">
  <img src="static/images/keshihua3.png" width="80%" alt="Visual Image" />
</div>

*Comparative visualization of attention maps and our model performance on the DrivePilot dataset.(b)*
...
<div align="center">
  <img src="static/images/introduce.jpg" width="80%" alt="Visual Image" />
</div>

*Comparative visualization of attention maps and our model performance on the DrivePilot dataset.(c) Ground truth bounding boxes are depicted in blue, while output bounding boxes of our model are highlighted inred. In the BEV and front-view images, the green box represents the predicted reference object, the yellow boxrepresents the ground truth reference object, and the grey boxes represent other detected objects. The coloredbands show the candidate paths planned by our model.*
