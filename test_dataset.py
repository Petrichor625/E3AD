...
from engine import train_Model_one_epoch, train_one_epoch_w_accum,evaluate_Model
from models import *
...
def main(args):
    ...
    if args.model_name == 'Model_without_score_and_gpt' or args.model_name == 'Model_V2_plus' or args.model_name == 'Model_V2':
    ...
    if args.model_name == 'Model_without_score_and_gpt':
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = epoch_trainer(model, criterion, data_loader_train, optimizer, device, epoch, args.epochs, args.clip_max_norm)
        ...
        val_stats, val_acc, _ ,val_score= epoch_eval(
        ...
        if args.output_dir and utils.is_main_process():
            ...
            epoch_logger.info('  '.join(
                [f'Epoch [{epoch + 1}](val_score)',
                 *[f'{k}: {v:.4f}' for k, v in val_score.items()]]))
            epoch_logger.info('\n')
