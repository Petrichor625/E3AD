...
from engine import train_one_epoch, train_one_epoch_w_accum, evaluate,evaluate_talk2car,val_output,test_output
from engine import * 
...
def get_args_parser():
    ...
    parser.add_argument('--box_xyxy', default=False,
...
def main(args):
    ...
    dataset_test = build_Talk2car_dataset(args=args, split_talk2car= 'test')
    ...
    plot_talk2car(model, criterion, postprocessor, prefetcher_val, device, args.save_pred_path,split='val')
...
if __name__ == '__main__':
    ...
    main(args)
# python work.py --config /home/tam/Documents/RSDLayerAttn/VLTVG/configs/VLTVG_R101_talk2car.py --checkpoint /home/tam/Documents/RSDLayerAttn/VLTVG/work_dirs/VLTVG_R101_talk2car/checkpoint0103.pth --batch_size_test 16 --test_split val