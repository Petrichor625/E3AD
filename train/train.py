...
import sys
sys.path.append('/home/zhenningli/lhc/Talk2car/VLTVG_RegionProposal')
import util.misc as utils
from util.misc import collate_fn_with_mask as collate_fn
from engine import *
from models import build_model,build_model_cavg
...
def get_args_parser():
    ...
    parser.add_argument('-- blip_pretrained', default='https://storage.googleapis.com/sfr-vision-language-research/BLIP/models/model_base_14M.pth')
...
def main(args):
    ...
    model, criterion, postprocessor = build_model_cavg(args)
    model.to(device)
    ...
    dataset_train = build_Talk2car_dataset(split_talk2car='train', args=args)
    dataset_val = build_Talk2car_dataset(split_talk2car='test', args=args)
...
if __name__ == '__main__':
    ...
    main(args)
# cd /home/tam/Documents/RSDLayerAttn/VLTVG/
# python /home/tam/Documents/RSDLayerAttn/VLTVG_RegionProposal/train.py --config /home/tam/Documents/RSDLayerAttn/VLTVG_RegionProposal/configs/VLTVG_R101_talk2car_Region_proposal.py
