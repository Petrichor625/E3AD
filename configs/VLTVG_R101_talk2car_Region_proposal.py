...
output_dir='/home/tam/Documents/RSDLayerAttn/VLTVG_RegionProposal/work_dirs/CAVG_RegionProposal'
...
model_config = dict(
    decoder=dict(
        type='DecoderWithExtraEncoder_with_Score',
        num_queries=1,
        query_dim=256,
        norm_dim = 256,
        ...
        num_extra_layers=1,
        extra_layer=dict(
            type='DiscriminativeFeatEncLayer_With_score',
            d_model=256,
