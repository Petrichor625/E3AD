...
from engine import train_one_epoch, train_one_epoch_w_accum, evaluate,evaluate_talk2car
...
def main(args):
    ...
    dataset_test = build_dataset(test=True, args=args, split_talk2car= 'test')

    dataset_val = build_dataset(test=True, args=args, split_talk2car= 'val')
...
if __name__ == '__main__':
    ...
    main(args)
# python test.py --config /home/tam/Documents/RSDLayerAttn/VLTVG/configs/VLTVG_R101_talk2car.py --checkpoint /home/tam/Documents/RSDLayerAttn/VLTVG/work_dirs/VLTVG_R101_talk2car/checkpoint0016.pth --batch_size_test 16 --test_split val
# python /home/tam/Documents/RSDLayerAttn/VLTVG/test.py --config configs/VLTVG_R50_gref.py --checkpoint /home/tam/Documents/RSDLayerAttn/VLTVG/work_dirs/VLTVG_R50_gref111/checkpoint0011.pth